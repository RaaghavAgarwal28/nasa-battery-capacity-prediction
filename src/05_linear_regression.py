...
MODEL_OUT_FOLDER = os.path.join(OUTPUT_FOLDER, "linear_regression")
...
print("Phase 5 : Multiple Linear Regression")
print("=" * 60)
...
# Sort by actual capacity to show a clean trend, or plot sorted indices
...
ax.set_title("Actual vs Predicted Capacity (Linear Regression)", fontsize=14, fontweight='bold')
...
ax.set_title("Residual Plot (Linear Regression)", fontsize=14, fontweight='bold')
...
ax.set_title("Prediction Error Plot (Linear Regression)", fontsize=14, fontweight='bold')
